Required Notice: Copyright (c) 2026 Oblivion Pictures — Michael de Meyer (https://howispulse.com)

This license applies to the Pulse server components. See `LICENSE` in the
repository root for which parts of Pulse are covered by which license.

Running a Pulse server beyond the trial period requires a commercial licence.
Contact https://howispulse.com for terms.
