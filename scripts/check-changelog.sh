...
NON_USER_FACING='(^|/)[^/]*\.md$|^docs/|^\.github/|^infra/|^packaging/|(^|/)scripts/|(^|/)Dockerfile[^/]*$|\.toml$|(^|/)package\.json$|/tests/|(^|/)conftest\.py$|/alembic/|^web/static/changelog\.json$|^web/static/install\.sh$'
