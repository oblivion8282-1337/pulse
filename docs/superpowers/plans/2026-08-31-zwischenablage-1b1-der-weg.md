...
**Plan 1c — macOS.** Host-Seite im `mac-hq-sidecar`, Steuernden-Seite im Player. `objc2` + `objc2-app-kit` im Player sind am 2026-08-31 vom Nutzer **freigegeben** — der Player hatte bis dahin keine einzige macOS-Abhängigkeit. Die Grenze bleibt hart: die Freigabe gilt für diese zwei Kisten und diesen Zweck.
