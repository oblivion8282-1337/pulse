...
<div class="relative flex min-h-dvh overflow-hidden">
  ...
  >
    {#if step === 'credentials'}
      <form
        class="bg-card border-border/60 w-full max-w-md space-y-4 rounded-xl border p-8 shadow-2xl"
        onsubmit={submit}
  ...
  <div class="absolute inset-x-0 bottom-0 z-40 flex justify-center p-4">
    <LegalFooter />
  </div>
</div>
