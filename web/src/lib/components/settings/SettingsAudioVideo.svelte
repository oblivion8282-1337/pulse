<script lang="ts">
  ...
  // onNoiseModelChange entfiel mit dem GTCRN-Rückbau (2026-09-11): es gab
  // nur diesen einen zweiten Modellfall — die RNNoise-Kette schaltet der
  // NS-Schalter selbst um.
