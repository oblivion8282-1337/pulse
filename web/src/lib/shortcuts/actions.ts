...
export const ACTIONS: readonly ActionDef[] = [
  { id: 'nav.quickSwitcher', category: 'navigation', label: 'Schnell-Wechsler',
    description: 'Channel/Server suchen', defaultBinding: 'ctrl+k', context: 'global' },
  { id: 'nav.channelUp', category: 'navigation', label: 'Channel hoch',
    description: 'Vorheriger Channel im Server', defaultBinding: 'alt+arrowup', context: 'global' },
  { id: 'nav.channelDown', category: 'navigation', label: 'Channel runter',
    description: 'Nächster Channel im Server', defaultBinding: 'alt+arrowdown', context: 'global' },
  { id: 'nav.serverUp', category: 'navigation', label: 'Server hoch',
    description: 'Vorheriger Server', defaultBinding: 'ctrl+alt+arrowup', context: 'global' },
  { id: 'nav.serverDown', category: 'navigation', label: 'Server runter',
    description: 'Nächster Server', defaultBinding: 'ctrl+alt+arrowdown', context: 'global' },
