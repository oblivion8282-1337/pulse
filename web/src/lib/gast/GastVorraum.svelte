<script lang="ts">
   ...
   *
   * Bewusst karg. Der Gast hat kein Konto, keine Einstellungen und keinen
   * zweiten Bildschirm — alles, was hier steht, muss er in zehn Sekunden
   * verstehen.
   */
...
<div class="mx-auto flex min-h-dvh w-full max-w-md flex-col justify-center gap-6 p-6">
