...
- `ablage` — `data`. Ein Rahmen der geteilten Zwischenablage, der zur
  ...
  verwirft daran, was nicht vom Träger kommt. Nur Windows-Sidecar (seit
  2026-08-31).
