...
//! warum es Pulses `pulse-kms-helfer` gibt. [`crate::karte::BildFehler`]
//! benennt den Fall ausdruecklich, statt an einem leeren Bild zu raten.
//!
//! **Diese Datei lag bis zum 2026-08-08 im Sidecar** (`src/system/drm_ioctl.rs`,
//! jetzt eine Weiterleitung hierher). Sie ist mit umgezogen, weil das
//! Helfer-Programm dieselben ioctls braucht — in derselben Fassung, sonst faellt
//! ein Unterschied erst beim Nutzer auf.
