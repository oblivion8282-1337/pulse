...
/// Dafuer sind `dups` (kein neues Bild zum Takt) und `slow` (Takt ueber
/// Budget) im [`crate::tick_monitor`] zustaendig, und die messen es direkt
/// statt es aus der Zeitachse zu erraten. Diese Schwelle meldet einen
