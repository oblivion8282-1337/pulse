...
/// Protokoll-Version im Hello-Frame. **2** seit dem Serverweg (v1 hat nie
/// ausgeliefert, es gibt keinen Bestand mit Anspruch auf Rücksicht) — ein
/// v1-Sender wird abgewiesen statt still anders verstanden.
