...
// eine Anforderung je 500 ms — aber PFADWEIT. Eine schaerfere Bremse an dieser
...
/// MediaMTX-Patch 0002: hoechstens eine Anforderung je 500 ms. Sie ABSICHTLICH
/// kleiner als [`ABSTAND_LANGSAM`] — die Treppe hier bedient die ersten zwei
/// Anforderungen sofort, und eine gleich grosse Server-Drossel nahm einem
/// zweiten Zuschauer genau diese schnelle Reparatur weg. Am 2026-08-15 kurz
/// auf 2 s gestanden und wieder zurueckgedreht.)
