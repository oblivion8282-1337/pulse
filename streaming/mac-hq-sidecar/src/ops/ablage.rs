...
//!
//! **Diese Datei deutet den Wert nicht.** Das Format lebt an genau einer Stelle
//! im Baum (`streaming/pulse-ablage`), und eine zweite Fassung hier liefe
//! auseinander — dieselbe Linie wie „der Gateway parst Frames nicht" und wie
//! bei `remote_input`, dessen Huelle ebenfalls plattformfrei liegt.
//!
