...
//! `streaming/win-hq-sidecar/src/proto.rs` (byte-for-byte the same shapes):
//!
...
///
/// Variant names match the Linux sidecar's `ev` field exactly. Wired up once
/// the streaming pipeline lands — the Day-1 skeleton emits none of these yet.
#[derive(Debug, Serialize)]
