//! **Seit dem 2026-08-21 gemeinsam.** Die Bildmarke kam am 2026-08-20 auf
//! `main` als 412-Zeilen-Zwilling in BEIDE Sidecars und den Player — und ein
//! Test hielt die drei Fassungen wortgleich. Genau die Sorte Doppelung, die
//! dieser Zweig gerade beseitigt hatte; deshalb wandert sie beim
//! Zusammenfuehren mit in eine eigene Kiste.
//!
//! Eine EIGENE Kiste und nicht `pulse-whip`, weil der Player sie ebenfalls
//! braucht — er empfaengt, sendet aber nicht, und haengt deshalb nicht am
//! Sendeweg.
